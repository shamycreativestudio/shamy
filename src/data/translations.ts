...
export const translations: Record<LangKey, Record<string, string>> = {
  es: {
    ...
    "services.subtitle": "Estrategia de marca, diseño editorial, interfaces interactivas y animación desarrolladas con rigor técnico y criterio estético.",
    ...
    "portfolio.subtitle": "Una selección curada de proyectos en branding, desarrollo web y animación, creados con propósito e identidad propia.",
  ...
  en: {
    ...
    "services.subtitle": "Brand strategy, editorial design, digital interfaces, and interactive web experiences built with technical rigor and aesthetic craft.",
    ...
    "portfolio.subtitle": "A curated selection of our work across branding, web development, and animation, crafted to stand out with purpose and identity.",
