...
export const translations: Record<LangKey, Record<string, string>> = {
  es: {
    ...
    "services.process.step1.desc": "Inmersión en tu visión y objetivos clave.",
    "services.process.step2": "Estrategia",
    "services.process.step2.desc": "Concepto y dirección creativa sólida.",
    "services.process.step3": "Diseño",
    "services.process.step3.desc": "Exploración y refinamiento iterativo.",
    "services.process.step4": "Entrega",
    "services.process.step4.desc": "Lanzamiento y sistemas listos para escalar.",
    ...
    "about.values.v1.desc": "Obsesión por los detalles finos, la tipografía y la armonía visual.",
    "about.values.v2.title": "Diseño con propósito",
    "about.values.v2.desc": "Creatividad fundamentada en objetivos claros que resuelven problemas reales.",
    "about.values.v3.title": "Experiencias memorables",
    "about.values.v3.desc": "Marcas e interfaces que no solo funcionan con precisión, sino que dejan una huella emocional duradera.",
  ...
  en: {
    ...
    "services.process.step1": "Briefing",
    "services.process.step1.desc": "Deep dive into your vision and core goals.",
    "services.process.step2": "Strategy",
    "services.process.step2.desc": "Rock-solid concept and creative direction.",
    "services.process.step3": "Design",
    "services.process.step3.desc": "Iterative exploration and meticulous refinement.",
    "services.process.step4": "Delivery",
    "services.process.step4.desc": "Launch and scalable design systems ready to grow.",
    ...
    "about.values.v1.desc": "Obsession with fine details, typography, and visual harmony.",
    "about.values.v2.title": "Purposeful design",
    "about.values.v2.desc": "Creativity grounded in clear objectives solving real challenges.",
    "about.values.v3.title": "Memorable experiences",
    "about.values.v3.desc": "Brands and interfaces that not only operate flawlessly, but leave a lasting emotional impact.",
