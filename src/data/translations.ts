...
export const translations: Record<LangKey, Record<string, string>> = {
  es: {
    ...
    "about.desc": "Somos un estudio creativo especializado en branding, diseño editorial e interfaces digitales. Creemos que cada píxel cuenta y que el diseño debe contar la historia de tu marca.",
